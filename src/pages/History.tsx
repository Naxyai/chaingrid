...
import { History as HistoryIcon, ExternalLink, Wallet, RefreshCw, ArrowDownToLine } from 'lucide-react';
import Layout from '../components/Layout';
import WalletModal from '../components/WalletModal';
import { useApp } from '../context/AppContext';
import { getUserCycles, getUserWithdrawals } from '../lib/supabase';
import { BSCSCAN_BASE } from '../lib/constants';
import { Cycle, Withdrawal } from '../types';

type Tab = 'cycles' | 'withdrawals';
      ...
      <Layout>
        <div className="min-h-[60vh] flex items-center justify-center">
          <div className="text-center max-w-md">
            ...
            <p className="text-gray-400 mb-6">Connect your wallet to view your complete cycle and withdrawal history.</p>
  ...
  return (
    <Layout>
      <div className="mb-8">
        ...
        <p className="text-gray-400">Complete record of your cycles and withdrawals</p>
      </div>

      <div className="flex gap-2 mb-6 p-1 rounded-xl bg-slate-800/40 border border-white/5 w-fit">
        {(['cycles', 'withdrawals'] as Tab[]).map((t) => (
          <button
            key={t}
            onClick={() => setTab(t)}
          ...
          >
            {t} ({t === 'cycles' ? cycles.length : withdrawals.length})
          </button>
        ))}
      </div>
              ...
              <table className="w-full text-sm">
                <thead className="border-b border-white/5">
                  <tr className="text-left text-gray-500 text-xs">
                    ...
                    <th className="p-4 font-medium text-right">Gross Reward</th>
